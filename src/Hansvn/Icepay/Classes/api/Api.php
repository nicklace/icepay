<?php namespace Hansvn\Icepay\API;

use Hansvn\Icepay\ParameterValidation;
...
class Api {
    ...
    public function setLogger($logger) {
        if(get_class($logger) == "Hansvn\Icepay\API\Logger")
            $this->_logger = $logger;
        else
            throw new Exception("Logger must be an instance of 'Hansvn\Icepay\API\Logger' on setLogger", 500);
    }
