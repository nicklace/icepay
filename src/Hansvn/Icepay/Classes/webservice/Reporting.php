...
/**
 * @package API_Reporting
 */
class Reporting extends Webservice {

    protected $service = 'https://connect.icepay.com/webservice/report.svc?wsdl';
    protected $_autokill = false;
    protected $_sessionName = "icepay_api_webservicereportingsession";
    protected $_session;
    protected $_username;
    ...
    {
        setcookie("icepay_api_webservicereportingsession_SessionID", '', time() - 1000);
        setcookie("icepay_api_webservicereportingsession_Timestamp", '', time() - 1000);
    }
    ...
    public function setSessionName($name = "icepay_api_webservicereportingsession")
    {
