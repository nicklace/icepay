...
class PaymentObject implements PaymentObjectInterface {
    ...
    protected function loadBasicPaymentMethodClass()
    {
        ...
        if (!class_exists("ApiBasic"))
            return $this;

        $this->pm_class = ApiBasic::getInstance()
                            ->readFolder()
     ...
     * @since version 2.1.0
     * @access public
     * @return BasicPaymentmethodInterface
     */
    ...
    {
        if (!ParameterValidation::language($lang))
