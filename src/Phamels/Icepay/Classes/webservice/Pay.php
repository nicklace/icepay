...
use Phamels\Icepay\PaymentObjectInterface;

/**
 * @package Checkout
 */
class Pay extends Webservice {
    ...
    public function autoCheckout(PaymentObjectInterface $paymentObj, $consumerID)
    {
        $obj = new \stdClass();
    ...
    public function vaultCheckout(PaymentObjectInterface $paymentObj, $consumerID, $getUrlOnly = false)
    {
        $obj = new \stdClass();
     ...
     * @since version 2.1.0
     * @access public
     * @param PaymentObjectInterface $paymentObj
     * @param bool $geturlOnly
     * @return array result
     */
    public function checkOut(PaymentObjectInterface $paymentObj, $getUrlOnly = false)
    {
        $obj = new \stdClass();
     ...
     * @return array result
     */
    public function phoneCheckout(PaymentObjectInterface $paymentObj, $getUrlOnly = false)
    {
        $obj = new \stdClass();
     ...
     * @return array
     */
    public function smsCheckout(PaymentObjectInterface $paymentObj, $getUrlOnly = false)
    {
        $obj = new \stdClass();
     ...
     * @return array result
     */
    public function phoneDirectCheckout(PaymentObjectInterface $paymentObj)
    {
        $obj = new \stdClass();
