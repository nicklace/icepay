<?php namespace Phamels\Icepay\Order;
...
class Order {
     ...
     * 
     * @since 1.0.0
     * @param obj Object containing the OrderConsumer class
     * @return Order
     */
    public function setConsumer(OrderConsumer $obj) {
     ...
     * 
     * @since 1.0.0
     * @param obj Object containing the OrderAddress class
     * @return Order
     */
    public function setShippingAddress(OrderAddress $obj) {
     ...
     * @return Order
     */
    public function setBillingAddress(OrderAddress $obj) {
     ...
     * 
     * @since 1.0.0
     * @param obj object containing the OrderProduct class
     * @return Order
     */
    public function addProduct(OrderProduct $obj) {
    ...
    public function setOrderDiscountAmount($amount, $name = 'Discount', $description = 'Order Discount') {
        $obj = OrderProduct::create()
                ->setProductID('02')
                ->setProductName($name)
                ->setDescription($description)
                ->setQuantity('1')
                ->setUnitPrice(-$amount)
                ->setVATCategory(OrderVAT::getCategoryForPercentage(-1));
    ...
    public function setShippingCosts($amount, $vat = -1, $name = 'Shipping Costs') {
        $obj = OrderProduct::create()
                ...
                ->setQuantity('1')
                ->setUnitPrice($amount)
                ->setVATCategory(OrderVAT::getCategoryForPercentage($vat));
